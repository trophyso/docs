...
You can also read and update `controlRatio` and `userActivationWindow` with the [organization settings Admin API](/admin-api/endpoints/settings/update-organization-settings).
