...
In this case, you would configure the lessons completed metric to contribute to streak's but not the words learned metric.
...
This section outlines some of the operations you can perform to manage users' streaks in your application.

### Restoring A Users Streak

To restore a users streak, head to the user details page and use the 'Restor Streak' action. Restoring a users streak sets it to the length it was when they last lost it.
