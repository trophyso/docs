---
title: Data sync
description: Learn how to sync Trophy data to your warehouse or database for analytics and reporting.
og:description: Learn how to sync Trophy data to your warehouse or database for analytics and reporting.
icon: database
---
...
Please [contact the support team](mailto:support@trophy.so) to connect your destination. We'll understand the specifics of your set up, help you create the neccesary tables and create a secure connection.
