---
title: Environments
description: Use Trophy environments to test and review gamification changes in development or staging before releasing achievements, streaks, and points to production.
