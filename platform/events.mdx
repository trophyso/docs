...
"og:description": Events are data objects that record continual user interactions against metrics in Trophy.
icon: radio
---
...
Watch Charlie integrate metric tracking into a simple NextJS application using the NodeJS SDK:
