...
> </video>
  ...
  <Step title="Associate device tokens">
    To send notifications to users, Trophy needs to know the unique token assigned to their device. You tell Trophy about devices by associating device tokens with each user you identify.
