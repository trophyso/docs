...
<ParamField path="deviceTokens" type="array<string>">
  ...
  Trophy [Push Notifications](/platform/push-notifications), then they'll only
...
You can use Trophy to send gamified [Emails](/platform/emails) and [Push Notifications](/platform/push-notifications) to your users.
