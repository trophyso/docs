...
Users must be individuals, they cannot be companies or organisations. To create organisational strcutures or user groupings, consider using a [custom user attribute](#custom-user-attributes).
...
Use custom user attributes across Trophy to personalize gamification features and to segment and compare user cohorts in analytics.

#### Feature Personalization

Custom user attributes can be used to personalize achievements, customize the way points are earned by different users and much more. Follow the links to the relevant pages below to learn more.

<CardGroup>
  <Card title="Personalizing Achievements" icon="trophy">
    Configure achievements that can only be unlocked by specific users.
  </Card>
  <Card title="Personalizing Points" icon="sparkle">
    Personalize how different users earn points.
  </Card>
  <Card title="Email Segmentation" icon="split">
    Control which users receive gamified emails.
  </Card>
  <Card title="Email Personalization" icon="trophy">
