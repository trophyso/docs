...
On the leaderboard configuration page, create or select your user attribute in the 'Breakdown Attribute' field. Trophy will automatically start grouping usres into smaller leaderbaord sbaed on the values of the attribute for each of your users.
