...
<Tip>
  ...
  the retention of each user interaction, then configure acheivements around
...
<AccordionGroup>
  <Accordion title="What type of achievements should I use?">
    ...
    Use Trophy's [metric analytics](/platform/metrics#metric-analytics) to compare the retention of each user interaction, then configure acheivements around these interactions to maximize retention impact.
