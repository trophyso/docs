...
Most webhook emitters, including Trophy, operate on an "at least once" delivery guarantee. This means you will eventually receive the same webhook multiple times and your code needs to handle those scenarios without unintended consequences.
