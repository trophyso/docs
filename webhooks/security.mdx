---
title: Security
description: Build secure Trophy webhook endpoints using HMAC signature verification, replay protection, and best practices to confirm payloads come from Trophy.
...
## Securing Webhook Handlers {#securing-webhook-handlers}
