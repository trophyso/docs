...
To help you secure your webhook handlers so that they only respond to events sent from Trophy and not mailicious attackers, Trophy includes a webhook signature with every event.
