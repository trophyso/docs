---
title: Introduction
description: Use Trophy webhooks to receive real-time events for achievements, streaks, points, and level changes, and power custom gamification integrations.
