---
title: Usuarios
description: Rastrea Usuarios de Trophy en tu producto para atribuir eventos, guardar atributos y personalizar logros, rachas, puntos y clasificaciones.
...
Esto devolverá los detalles completos del usuario junto con el atributo `control` que puedes usar para inscribir condicionalmente a usuarios en cualquier función de gamificación. Obtén más información sobre [Experimentación](/es/platform/experimentation).
