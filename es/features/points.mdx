...
Los puntos pueden otorgarse o deducirse de forma continua a medida que los usuarios incrementan las [Métricas](/es/features/metrics). Puedes elegir otorgar o deducir cualquier número arbitrario de puntos en cualquier umbral de métrica arbitrario, por ejemplo "otorgar 10 puntos por cada 3 tareas completadas".

#### Activadores de Racha {#streak-triggers}

Los Puntos se pueden otorgar o deducir al alcanzar cualquier duración arbitraria de una [Racha](/es/features/streaks), por ejemplo "otorgar 50 puntos por cada racha de 7 días".
...
- Para limitar un **activador de métrica** a que solo se aplique a eventos con [atributos de evento personalizados](/es/features/events#custom-event-attributes) específicos, agrega uno o más filtros en la sección **Atributos de Evento**.

- Para limitar cualquier tipo de activador a que solo se aplique a un usuario con uno o más [atributos de usuario personalizados](/es/features/users#custom-user-attributes) específicos, agrega atributos y los valores deseados en la sección **Atributos de Usuario**.
...
- **Impulsos globales** multiplican los puntos ganados por todos los usuarios durante la ventana del impulso, o pueden limitarse a una cohorte de usuarios específica utilizando [atributos de usuario personalizados](/es/features/users#custom-user-attributes).
...
<Steps>
  ...
  <Step title="Agrega filtros de atributos (opcional)">
    ...
    <Note>
      Esta función requiere [atributos de usuario personalizados](/es/features/users#custom-user-attributes) que están disponibles en el plan [Pro](/es/account/billing#pro-plan).
    </Note>
    ...
    <Frame>
      <img
        ...
        width="100%"
        noZoom
        src="../../assets/features/points/points_boost_attributes.png"
      />
    </Frame>
  </Step>
...
Cuando envías un [evento de cambio de métrica](/es/api-reference/endpoints/events/submit-a-metric-event), la respuesta incluirá un mapa `points` indexado por las claves de tu sistema de puntos para cada sistema que cambió como resultado del evento.
...
En primer lugar, cualquier punto otorgado o deducido de los usuarios como resultado de un evento de cambio de métrica se devuelve en la respuesta al usar la [API de evento de cambio de métrica](/es/api-reference/endpoints/events/submit-a-metric-event).
...
<Frame>
  <img height="200" noZoom src="../../assets/features/points/points_awards.png" />
</Frame>
...
<Frame>
  <img
    height="200"
    noZoom
    src="../../assets/features/points/user_points_summary.png"
  />
</Frame>
...
<Frame>
  <img height="200" noZoom src="../../assets/features/points/points_summary.png" />
</Frame>
...
<Frame>
  <img
    height="200"
    noZoom
    src="../../assets/features/points/points_triggers.png"
  />
</Frame>
...
<Frame>
  <img
    height="200"
    noZoom
    src="../../assets/features/points/points_analytics.png"
  />
</Frame>
