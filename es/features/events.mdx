---
title: Eventos
description: Envía eventos de Trophy desde tu aplicación para registrar interacciones de usuarios, actualizar métricas y disparar logros, rachas, puntos y clasificaciones.
