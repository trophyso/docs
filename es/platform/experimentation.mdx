...
<Note>
  Trophy also doesn't send any [Emails](/es/features/emails) or [Push
  Notifications](/es/features/push-notifications) to users who are in the control
  group.
</Note>
...
As Trophy tracks user interactions through [Metrics](/es/features/metrics), it can give you insights into how active your users are against each, and in aggregate.
