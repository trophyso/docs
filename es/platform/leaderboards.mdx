...
Las clasificaciones en Trophy pueden configurarse para agrupar a los usuarios en grupos más pequeños según un [atributo de usuario personalizado](#custom-user-attributes) específico.
...
<Steps>
  ...
  <Step title="Introduce una clave única">
   ...
   <Step title="Elige un método de clasificación">
    Elige uno de los [métodos](#ranking-method) por el cual la clasificación clasificará a los usuarios:
    ...
    Guarda y ve a la página de configuración para establecer [fechas de inicio y finalización](#start-and-end-dates), [programaciones de clasificaciones repetidas](#repeating-leaderboards) y más.
    </Step>
...
<AccordionGroup>
  <Accordion title="¿Cuántos participantes puede tener una clasificación a la vez?">
