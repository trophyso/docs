...
<Steps>
  ...
  <Step title="Crea tu primera métrica">
    Todas las funciones de gamificación están impulsadas por las interacciones del usuario. En Trophy, utilizas [Métricas](/es/platform/metrics) para definir y modelar esas interacciones y [Eventos](/es/platform/events) para rastrearlas.
