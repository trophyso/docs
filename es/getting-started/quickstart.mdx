...
<Steps>
  ...
  <Step title="Añade el SDK de Trophy a tu backend">
    ...
    Alternativamente, puedes llamar directamente a la API usando cualquier biblioteca HTTP del lado del servidor.
  ...
  <Step title="Crea tu primera métrica">
    Todas las funciones de gamificación se basan en las interacciones del usuario. En Trophy, usas [Métricas](/es/platform/metrics) para definir y modelar esas interacciones y [Eventos](/es/platform/events) para rastrearlas.
  ...
  <Step title="Integra la métrica en tu backend">
    Una vez creada la métrica, dirígete a la pestaña de configuración y copia su clave de referencia API única.
    ...
    Al realizar esta llamada, le indicas a Trophy que un usuario específico realizó una interacción con tu producto. Como resultado, Trophy procesará automáticamente cualquier función de gamificación como logros o rachas que hayas configurado para la métrica.

  </Step>
  <Step title="Continúa construyendo tu experiencia de gamificación">
    Con una métrica integrada en tu backend, estás listo para empezar a añadir funciones de gamificación a tu producto.
