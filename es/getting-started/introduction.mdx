...
description: "Documentación de Trophy para APIs de gamificación: guías de inicio rápido, referencias de SDK, tutoriales y docs de logros, rachas, puntos y más."
---
...
Facilita la creación de funciones como [Logros](/es/features/achievements), [Rachas](/es/features/streaks), [Puntos](/es/features/points) y [Clasificaciones](/es/features/leaderboards) con solo unas pocas líneas de código, y puede enviar [correos electrónicos](/es/features/emails) y [Notificaciones push](/es/features/push-notifications) gamificados para aumentar tu retención y engagement.

<CardGroup>
  <Card title="Conceptos de Trophy" icon="book-open" href="/es/features">
    Familiarízate con el modelo mental de gamificación en Trophy.
  </Card>
  <Card
    title="Inicio rápido"
    icon="circle-play"
