...
<Accordion title="Configurar puntos XP" icon="star">
  ...
  Luego configura **[Niveles de Puntos](/es/platform/points#points-levels)** en el mismo sistema `xp` para que Trophy pueda rastrear el nivel de cada usuario. Utiliza las claves y umbrales a continuación para que el código de esta guía se alinee con tu panel de control:
...
## Construyendo el Panel de Control {#building-the-dashboard}
...
### Utilidades de Ayuda {#helper-utilities}
