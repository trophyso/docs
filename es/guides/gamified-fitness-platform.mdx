...
Antes de profundizar en el código, entendamos cómo Trophy impulsa nuestra capa de gamificación. En Trophy, las [Métricas](/es/features/metrics) representan diferentes interacciones que los usuarios pueden realizar e impulsan funciones como [Logros](/es/features/achievements), [Rachas](/es/features/streaks) y [Correos Electrónicos](/es/features/emails).
...
<AccordionGroup>
  ...
  <Accordion title="Configurar puntos XP" icon="star">
    ...
    Luego configura **[Niveles de puntos](/es/features/points#points-levels)** en el mismo sistema `xp` para que Trophy pueda rastrear el nivel de cada usuario. Usa las claves y umbrales a continuación para que el código de esta guía coincida con tu panel:
