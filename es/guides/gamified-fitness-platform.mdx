...
description: Crea un rastreador de fitness gamificado tipo Strava con Next.js y Trophy, con seguimiento multideporte, clasificaciones por ciudad y XP normalizado.
