...
Podemos usar la respuesta de la [API de cambio de métrica](/es/api-reference/endpoints/events/submit-a-metric-event) para mostrar a los usuarios notificaciones emergentes cuando se les otorga nuevo XP.
