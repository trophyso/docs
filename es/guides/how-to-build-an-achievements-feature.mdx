...
Podemos usar la respuesta del [API de cambio de métrica](/es/api-reference/endpoints/events/submit-a-metric-event) para mostrar notificaciones emergentes (o 'toasts') cuando los usuarios completan logros.
