...
Esta API devuelve datos sobre la energía total del usuario, pero puede configurarse para devolver también entre 1 y 100 de los cambios de energía más recientes del usuario usando el [parámetro de consulta](/es/api-reference/endpoints/users/get-a-users-points#parameter-awards) `awards`.
