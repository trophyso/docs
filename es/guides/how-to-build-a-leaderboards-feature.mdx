...
Podemos utilizar la respuesta de la [API de cambio de métrica](/es/api-reference/endpoints/events/submit-a-metric-event) para mostrar notificaciones emergentes (o 'toasts') cuando los usuarios suben en las clasificaciones.
