---
title: Marca
description: Configura el logotipo, los colores de marca y la identidad visual de tu cuenta que se usan en correos, paneles y otras funciones de Trophy.
...
La [página de marca](https://app.trophy.so/branding) en el panel de Trophy le permite configurar los siguientes ajustes a nivel de cuenta. Estos ajustes se utilizarán en cualquier comunicación que configure Trophy para enviar a los usuarios, como [Correos electrónicos](/es/features/emails).
