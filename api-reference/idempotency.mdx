---
title: Idempotency
description: Use the `Idempotency-Key` header to safely retry Trophy API requests without double-counting events, double-awarding points, or duplicating user actions.
