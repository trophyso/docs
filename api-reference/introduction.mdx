---
title: Introduction
description: Authenticate, handle errors and rate limits, use idempotency, and explore Trophy Application API SDKs.
...
<CardGroup>
  ...
  <Card title="Errors" icon="circle-exclamation" href="/api-reference/errors">
    Common HTTP status codes for auth, rate limits, and metric events.
  </Card>
