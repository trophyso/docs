---
title: Rate Limiting
description: Understand Application API rate limits per endpoint, the headers Trophy returns, and how to handle 429 responses when tracking high-volume user events.
