...
description: Authenticate Trophy Application API requests using account-level API keys sent in the `X-API-KEY` header from your backend or trusted server environments.
