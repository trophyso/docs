...
You can also read and update organization streak configuration — frequency, evaluation mode, metrics, days off, personalization, and freezes — with the [streak settings Admin API](/admin-api/endpoints/streaks/update-streak-settings).
