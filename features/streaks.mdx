...
Once enabled, users will be able to customize the [streak conditions](#streak-conditions) that they must meet to extend their streak, including streak evaluation mode and the threshold for each metric, as well as personalize what days of the week that their streak will track their activity, through user preferences.
