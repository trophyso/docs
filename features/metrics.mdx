---
title: Metrics
description: Model any user interaction as a Trophy Metric and automatically drive achievements, streaks, points, and leaderboards from a handful of API calls.
