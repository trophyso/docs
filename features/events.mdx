---
title: Events
description: Send Trophy Events from your app to record user interactions, update metrics, and automatically trigger achievements, streaks, points, and leaderboards.
