---
title: Points
description: Build points and XP systems with Trophy, including triggers, multipliers, boosts, and level progression to reward user actions inside your product.
