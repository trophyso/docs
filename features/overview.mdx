---
title: Overview
description: Learn the key Trophy concepts—metrics, events, achievements, streaks, points, and leaderboards—that power gamified web and mobile product experiences.
