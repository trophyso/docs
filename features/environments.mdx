...
<AccordionGroup>
  <Accordion title="How many environments can I create?">
    ...
    - <Badge color="blue" stroke size="sm">Staging</Badge> - Multiple
    - <Badge color="gray" stroke size="sm">Development</Badge> - Multiple

    <Note>You can have more than one environment of the same type, but you cannot have more than one environment of the same `key`.</Note>

    If you feel you need more environments, please [get in touch](#get-support) and we'll be happy to discuss your needs.
  </Accordion>
