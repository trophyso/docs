...
- <Badge color="green" stroke size="sm">Production</Badge> (highest priority)
- <Badge color="blue" stroke size="sm">Staging</Badge>
- <Badge color="gray" stroke size="sm">Development</Badge> (lowest priority)
