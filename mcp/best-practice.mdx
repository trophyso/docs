...
Access is scoped to the Trophy organization you authorize during OAuth. Tools act on a specific [environment](/platform/environments) (defaults to `production` or pass another key when you have multiple).
