...
Trophy hosts a remote MCP endpoint. You install it once in your MCP client, sign in with OAuth using your Trophy account (and select the organization to authorize), and the client exposes tools your agent can call.

Those tools map to account operations — list/get for discovery, create/update for configuration, and dedicated actions for streak freezes, pauses, restores, settings, and reading analytics.
