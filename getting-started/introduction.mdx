...
<Tip>
Using Trophy's MCP servers is reccomended for a faster set up and development experience.
</Tip>
...
Before you deploy your integration to production, review the reccomended steps in the production checklist:
