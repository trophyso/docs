...
description: Trophy is the gamification layer for consumer apps. Build points,
  achievements, streaks, and leaderboards in minutes with Trophy's pre-built
  APIs and SDKs.
og:description: Trophy is the gamification layer for consumer apps. Build
  points, achievements, streaks, and leaderboards in minutes with Trophy's
