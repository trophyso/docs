...
Before deploying your Trophy integration to production, review the following reccomended steps:
...
<Steps>
  ...
  <Step title="Handle errors" titleSize="h2" id="errors">
    ...
    <Card title="Errors" icon="circle-exclamation" href="/api-reference/errors" icon="circle-x">
