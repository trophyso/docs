---
title: Quick Start
description: "Get up and running with Trophy in under 10 minutes: install an SDK, identify a user, send your first event, and trigger an achievement in your product."
