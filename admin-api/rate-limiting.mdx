---
title: Rate Limiting
description: Understand Admin API rate limits, the response headers Trophy returns, and how to handle 429 responses gracefully when running automated workflows.
