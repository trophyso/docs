...
description: Authenticate Admin API requests using account-level API keys passed in the `X-API-KEY` header to manage metrics, points, leaderboards, and tenants.
