...
As Trophy tracks user interactions through [Metrics](/en/platform/metrics), it can give you insights into how active your users are against each, and in aggregate.
