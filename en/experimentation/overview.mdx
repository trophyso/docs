---
title: Overview
description: Learn how to use Trophy to experiment with the gamification experience and increase retention and user engagement.
...
<Note>
  Trophy also doesn't send any [Emails](/en/platform/emails) or [Push
  Notifications](/en/platform/push-notifications) to users who are in the control
  group.
</Note>
...
<CardGroup>
  <Card title="Retention" icon="refresh-cw" href="/en/experimentation/retention">
    Learn how to measure the impact of gamification on retention
  </Card>
  <Card title="Engagement" icon="heart" href="/en/experimentation/engagement">
