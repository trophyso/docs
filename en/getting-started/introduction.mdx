...
It makes building features like [Achievements](/en/platform/achievements), [Streaks](/en/platform/streaks), [Points](/en/platform/points) and [Leaderboards](/en/platform/leaderboards) simple with just a few lines of code, and can send gamified [Emails](/en/platform/emails) and [Push Notifications](/en/platform/push-notifications) to increase your retention and engagement.
...
<CardGroup>
  ...
  <Card title="Guides" icon="rocket" href="/en/guides">
    Use Trophy to build practical solutions to common gamification use cases.
  </Card>
  <Card title="Platform" icon="box" href="/en/platform">
