...
<Steps>
  ...
  <Step title="Create your first metric">
    All gamification features are driven by user interactions. In Trophy, you use [Metrics](/en/platform/metrics) to define and model those interactions and [Events](/en/platform/events) to track them.
  ...
  <Step title="Integrate the metric into your backend">
    ...
    To track an event against this metric when a user interacts with your product, call the [metric change event API](/en/api-reference/endpoints/metrics/send-a-metric-change-event), passing along details of the user that made the interaction. In this example the metric key would be `flashcards-flipped`:
  ...
  <Step title="Continue building your gamification experience">
    ...
    <CardGroup>
      <Card title="Achievements" icon="trophy" href="/en/platform/achievements">
        Reward users for continued progress or taking specific actions.
      </Card>
      <Card title="Streaks" icon="flame" href="/en/platform/streaks">
        Motivate users to build regular usage habits.
      </Card>
      <Card title="Points" icon="sparkle" href="/en/platform/points">
      ...
      <Card
        ...
        href="/en/platform/leaderboards">
        Create friendly competitions to increase user engagement.
      </Card>
      <Card title="Emails" icon="mail" href="/en/platform/emails">
        Deliver personalized lifecycle emails to users at the perfect moment.
      </Card>
      <Card title="Push Notifications" icon="bell" href="/en/platform/push-notifications">
        Drive automated notification flows using personalized gamification data.
      </Card>
    </CardGroup>

    Or, explore our [API reference](/en/api-reference/introduction) to get familiar with what Trophy can do.
