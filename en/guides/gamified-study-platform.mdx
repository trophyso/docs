...
description: Follow along as we build out a gamified study platform using Trophy with achievements, a daily streak, XP and leaderboards.
...
- [Setup & Installation](#setup-%26-installation)
...
### Setting Up Flashcard Data {#setting-up-flashcard-data}
...
### Basic Flashcard Layout {#basic-flashcard-layout}
...
### Flipping Flashcards {#flipping-flashcards}
...
In Trophy, [Metrics](/en/platform/metrics) represent different interactions users can make and can drive features like [Achievements](/en/platform/achievements), [Streaks](/en/platform/streaks) and [Emails](/en/platform/emails).
...
In Trophy we track user interactions by sending [Events](/en/platform/events) from our code to Trophy against a specific metric.
...
Recording an event against a metric for a specific user makes use of Trophy's [metric event API](/en/api-reference/endpoints/metrics/send-a-metric-change-event), which in practice looks like this:
...
- First, we'll set up a _Flashcards Flipped_ metric
...
<Note>
  ...
  address](/en/platform/emails#sending-emails) with Trophy. But this can be done
...
### Integrating Trophy SDK {#integrating-trophy-sdk}
...
#### Achievement Unlocked Toasts {#achievement-unlocked-toasts}
...
#### Streak Extended Toasts {#streak-extended-toasts}
...
#### Displaying Study Journey {#displaying-study-journey}
...
### Setting Up Points in Trophy {#setting-up-points-in-trophy}
...
### Integrating Points API {#integrating-points-api}
...
### Creating a Points Context {#creating-a-points-context}
...
### Building the Points Center UI {#building-the-points-center-ui}
...
### Updating Points on Flashcard View {#updating-points-on-flashcard-view}
...
### Setting Up Leaderboards in Trophy {#setting-up-leaderboards-in-trophy}
...
### Leaderboard API Integration {#leaderboard-api-integration}
...
### Building the Leaderboard UI {#building-the-leaderboard-ui}
...
### Setting Up Energy in Trophy {#setting-up-energy-in-trophy}
...
### Energy API Integration {#energy-api-integration}
...
### Creating an Energy Context {#creating-an-energy-context}
...
### Building the Energy UI {#building-the-energy-ui}
