...
Metrics are the building blocks of the infrastructure that powers Trophy's gamification features. Each user interaction that relates to a metric is stored as an [Event](/en/platform/events).
...
## Metric Analytics {#metric-analytics}
...
### Achievement Completion Chart {#achievement-completion-chart}
...
[Learn more about achievements](/en/platform/achievements).
