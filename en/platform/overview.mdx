...
<CardGroup>
  <Card title="Metrics" icon="box" href="/en/platform/metrics">
    Model how users interact with your application.
  </Card>
  <Card title="Events" icon="radio-tower" href="/en/platform/events">
    Track user interactions against metrics.
  </Card>
  <Card title="Users" icon="users" href="/en/platform/users">
    Tell Trophy about the people using your application.
  </Card>
</CardGroup>

## Gamification Concepts {#gamification-concepts}
...
<CardGroup>
  ...
  <Card
    ...
    icon="bell"
    href="/en/platform/push-notifications"
  >
