...
We can use the response of the [metric change API](/api-reference/endpoints/events/submit-a-metric-event) to show pop-up notifications (or 'toasts') when users move up the rankings.
