...
You can also create [anniversary achievements](/features/achievements#anniversary-achievements) that unlock as users reach yearly milestones from their sign-up date.
...
To track an event (user interaction) against your metric, use the [metric change API](/api-reference/endpoints/events/submit-a-metric-event).
...
We can use the response of the [metric change API](/api-reference/endpoints/events/submit-a-metric-event) to show pop-up notifications (or 'toasts') when users complete achievements.
