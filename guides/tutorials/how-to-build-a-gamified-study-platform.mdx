...
```tsx src/app/flashcards.tsx [expandable] {24-27,49-51,72-74}
"use client";
...
Next up, we'll use the Trophy API to fetch a list of all the user's achievements and display them on their profile.
