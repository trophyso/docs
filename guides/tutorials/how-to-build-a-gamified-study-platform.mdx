...
The call it when the user views the next flashcard:
...
This makes it really easy for us to react to changes in the users progress and do whatever we want. In this example, eaech time Trophy tells us a user has unlocked a new achievement, or extended their streak we'll:
