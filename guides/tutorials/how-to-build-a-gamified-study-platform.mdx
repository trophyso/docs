...
Here we'll add distinct sound effects for each case where we show a toast to further engage the user.

For this we'll make use of the [use-sound package](https://github.com/joshwcomeau/use-sound) for React, using free sounds from [freesound.org](https://freesound.org/).
