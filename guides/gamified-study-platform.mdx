...
Next, to make sure NextJS shows our badges, we need to configure Trophy's image host as a trusted domain. If you use custom badge URLs on your own domain or CDN, add those hostnames here too, or use a plain `<img>` and skip remote patterns.
