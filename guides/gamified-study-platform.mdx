...
Recording an event against a metric for a specific user makes use of Trophy's [metric event API](/api-reference/endpoints/events/submit-a-metric-event), which in practice looks like this:
