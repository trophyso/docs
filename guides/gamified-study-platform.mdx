...
If you want to add more features to your study platform including an XP system built using Trophy's [points](/platform/points) feature, then check out the `demo` branch in the [GitHub repo](https://github.com/trophyso/example-study-platform).
